...
<html>
    ...
    <body>
        ...
        <div  class="contenedorlog" >
            ...
            <div>
                <h2 style="text-align: center">Iniciar Sesión</h2>
                 <form action="login" method="post">
                    ...
                    <input class="lg" type="password" placeholder="Contraseña" name="contrasena" required>
                    <input id="recordar" type="checkbox" value="recordar" /> <label>Recordar contraseña</label> 
            ...
            <div class="tc">
                <a href="./olvidadopass.html" >¿Contraseña olvidada?</a>
            </div>
            
            <div class="tc">
                <p>¿Aún no tienes cuenta? </p> 
                <a href="./register.html" class="button" style="margin-top:15px" >Regístrate</a>
            </div>
