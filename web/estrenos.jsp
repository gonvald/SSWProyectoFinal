...
<html>
	<head>
        ...
        <link rel ="stylesheet" href="cssprueba.css">
                            ...
                            <% ArrayList<Pelicula> estrenos = (ArrayList<Pelicula>) request.getAttribute("estrenos"); %>
				...
				<div class="topnav">
					...
					<a class="active" href="Estrenos">Estrenos</a>
					...
					<input type="text" placeholder="Buscador..">          
                                ...
                                <c:forEach items="${estrenos}" var="item">
                                    <div class="gallery">
                                        <a href="InfoPeli?id=${item.getId()} " >
                                                <img src="ImagenPeli?username=${item.getId()}" alt="Cinque Terre" id="imgpelicula">
                                                </a>
